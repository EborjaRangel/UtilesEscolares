      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="grid gap-6 md:grid-cols-2">
          ...
          <div className="card space-y-4">
            ...
            <DetailItem label="Dirección de entrega" value={formatDireccionDisplay(pedido)} />
            {pedido.alcaldia && (
              <>
                <DetailItem label="Alcaldía" value={pedido.alcaldia} />
                <DetailItem label="Colonia" value={pedido.colonia} />
                <DetailItem label="Código postal" value={pedido.codigo_postal} />
                <DetailItem
                  label="Números"
                  value={`Ext. ${pedido.numero_exterior}${pedido.numero_interior ? `, Int. ${pedido.numero_interior}` : ''}`}
                />
              </>
            )}
            {pedido.lat && pedido.lng && (
              <DetailItem
                label="Coordenadas"
                value={`${Number(pedido.lat).toFixed(5)}, ${Number(pedido.lng).toFixed(5)}`}
              />
            )}
            <DetailItem
              label="Cliente"
